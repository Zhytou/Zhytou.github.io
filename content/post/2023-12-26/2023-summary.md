...
转眼到了7月，我在继续按照着[CS自学指南](https://csdiy.wiki/)学习。那段时间，我先后学习了NJU-OS和CS144，完成了其配套的实验，同时也产出了几篇博客。尤其是CS144这门课几乎是重塑了我对网络的认识，把之前死记硬背的好多知识给理解了；NJU-OS的参考教材[OSTEP](https://pages.cs.wisc.edu/~remzi/OSTEP/)也让我对操作系统中的许多知识有了更深刻的认识。总之这两门课程还是给了我很多收获的。
